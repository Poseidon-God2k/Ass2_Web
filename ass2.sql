...
-- Thời gian đã tạo: Th12 28, 2020 lúc 10:03 AM
...
INSERT INTO `accounts` (`Id`, `Email`, `Name`, `Password`, `IsManager`) VALUES
(2, 'lilac@yahoo.com.vn', 'lilac0307', 'lilac0307', 0),
(3, 'an@hcmut.edu.vn', 'lilac', 'lilac0307', 0),
(4, 'lucquyen@gmail.com', 'lucquyen', 'quyenluc123', 1),
(5, 'dolethienan@yahoo.com', 'dolethienan', 'lilac0300', 0);
...
(78, 3, 1600000, 1, '43', 'Giày Thể Thao Nike Nam Chạy Bộ Thời Trang Rival AA7400-401', 'https://cf.shopee.vn/file/79393485da3e6d2e5d7bf82d22a4aec6', 3),
(80, 3, 700000, 1, 'S', 'adidas ORIGINALS Trefoil Tee Nữ Màu đen FM3311', 'https://cf.shopee.vn/file/6751fc493a7d6b51c3e26b76cb08696b', 11),
(85, 5, 2500000, 1, '44', 'adidas ORIGINALS Giày Boost Unisex nam Màu trắng FX9519', 'https://cf.shopee.vn/file/e57ecabc34a8b9d6cf4764bd4adf592f', 14);
...
(19, 'adidas ORIGINALS Áo phông Trefoil Unisex Màu đen DV2905', 100, 600000, 'Cổ thuyền có gân ,48% cotton 47% modal 5% elastane single jersey ,Áo thun 3 sọc ,Không Bảo Hành ,Xuất Xứ Thương Hiệu: Đức', 'XS,S,L,XL', 4),
(26, 'Giày Thể Thao Nike Nam Thời Trang SP19 HUARACHE', 100, 2000000, 'Thiết kế thân lưới tạo cảm giác thông thoáng cho bàn chân ,Đế giữa và miếng lót cho lớp đệm chân mỏng nhẹ êm ái ,Đế giày xẻ rãnh chống trơn trượt', '41,42,43,44,45', 4),
(27, 'Giày Thể Thao Adidas Ultraboost 20 Nam Đen Xám FV8333', 100, 2500000, 'Thiết kế thân lưới tạo cảm giác thông thoáng cho bàn chân ,Đế giữa và miếng lót cho lớp đệm chân mỏng nhẹ êm ái ,Đế giày xẻ rãnh chống trơn trượt', '41,42,43,44,45', 4);
...
(77, 26, 'https://cf.shopee.vn/file/ded395cbae528adf23feb3e636afbb1e'),
(78, 26, 'https://cf.shopee.vn/file/e223fc2674151ef8e5ce27e42df7ad36'),
(79, 26, 'https://cf.shopee.vn/file/40b80ae5a925127b0e032cb0d2a2d52b'),
(80, 26, 'https://cf.shopee.vn/file/4cf1bb2726bf07b0d782895815e256bf'),
(81, 27, 'https://cf.shopee.vn/file/8074e20de42fab47106dc7c9b4eed749'),
(82, 27, 'https://cf.shopee.vn/file/6480b763f16152b74b4dc5c5aff95272'),
(83, 27, 'https://cf.shopee.vn/file/c5a1a1f87e43538bec0b9715c89758c9'),
(84, 27, 'https://cf.shopee.vn/file/db019a9a0d1297fe5189cbe5b98cbc46');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `user accounts`
--
...
--
-- Đang đổ dữ liệu cho bảng `user accounts`
--

INSERT INTO `user accounts` (`Id`, `Phone`, `First Name`, `Last Name`, `Creation Date`) VALUES
(2, NULL, NULL, NULL, '2020-12-27 14:56:19'),
(5, 20000000, 'An', 'Do Le Thien', '2020-12-28 01:05:58');
...
--
-- Chỉ mục cho bảng `user accounts`
--
...
--
ALTER TABLE `products_images`
  MODIFY `id_img` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
ALTER TABLE `carts`
  ...
  ADD CONSTRAINT `carts_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `accounts` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Các ràng buộc cho bảng `user accounts`
--
ALTER TABLE `user accounts`
  ADD CONSTRAINT `user accounts_ibfk_1` FOREIGN KEY (`Id`) REFERENCES `accounts` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
